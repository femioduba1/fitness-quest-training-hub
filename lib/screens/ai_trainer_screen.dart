...
class AITrainerScreen extends StatefulWidget {
  ...
  @override
  State<AITrainerScreen> createState() =>
      _AITrainerScreenState();
}
                    ...
                    child: Column(
                      children: [
                        _HowItWorksRow(
                          ...
                          description:
                              'Analyzes your recent logs to suggest which muscle group to train next.',
                        ...
                        _HowItWorksRow(
                          ...
                          description:
                              'Warns you when you\'ve trained the same muscle group too frequently.',
                          primaryText: primaryText,
                          secondaryText: secondaryText,
                        ),
                        Divider(color: borderColor),
                        _HowItWorksRow(
                          ...
                          description:
                              'Recommends rest or active recovery when your streak indicates fatigue.',
                          primaryText: primaryText,
                          secondaryText: secondaryText,
                        ),
                        Divider(color: borderColor),
                        _HowItWorksRow(
                          ...
                          description:
                              'Monitors your weekly goal and alerts you when you\'re falling behind.',
                          primaryText: primaryText,
                          secondaryText: secondaryText,
                        ),
                      ],
